export function Story() {
    return (
        ...
        <section className="py-24 px-2 max-w-7xl flex flex-col lg:flex-row items-center justify-center gap-5">

            {/** Colonne de gauche : Titre + Homme */}
            <div className=" flex flex-col">
                <span className="text-red-500 font-bold text-xs tracking-widest uppercase mb-2 block">
                    Our story
                </span>
                ...
                <div className="w-2/3 lg:w-2/3 h-[350] lg:h-[450] rounded-lg overflow-hidden">
            ...
            <div className="flex flex-col lg:pt-20">
                ...
                <div className="relative w-3/5 lg:w-2/3 h-[250] lg:h-[350] mb-4">
                    {/** Motif de fond (Mis un peu plus en haut à droite) */}
                    <div className="absolute right-18 bottom-55 text-blue-600 rounded-full text-6xl z-40">
                        <img src="Fill_1.png" alt="Cercle avec des points" />
                    </div>

                    {/** Image de la femme (Ajustée à gauche) */}
                    <div className="absolute left-0 top-20 w-2/3 h-4/5 rounded-2xl overflow-hidden z-20">
                        <img src="/2.png" alt="Strategy planning" className="w-full h-full object-cover bg-gray-300" />
                    </div>

                    {/** Image détail (Ajustée en bas à droite) */}
                    <div className="absolute left-80 bottom-0 w-3/5 h-1/2 rounded-xl overflow-hidden z-30">
